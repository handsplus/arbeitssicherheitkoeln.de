...
import { sifaPagePath } from "@/config/site";

const services = [
  {
    title: "Externe Fachkraft für Arbeitssicherheit",
    linkLabel: "Zur externen SiFa-Betreuung in Köln",
  ...
  },
  {
    ...
    linkLabel: "Zur Gefährdungsbeurteilung",
  ...
  },
  {
    ...
    linkLabel: "Zu Unterweisungen & Schulungen",
  ...
  },
  {
    ...
    linkLabel: "Zu Betriebsanweisungen & Dokumentation",
  ...
  },
  {
    ...
    linkLabel: "Zu Sicherheitsbegehungen",
  ...
  },
  {
    ...
    linkLabel: "Zu Beratung & gesetzlichen Anforderungen",
